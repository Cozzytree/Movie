      ...
      <div className="w-full flex flex-col sm:container mx-auto h-screen items-center gap-5 py-6 px-4 relative">
        ...
        <div className="w-full flex justify-between mt-5">
          <div className="sm:flex items-center gap-2">
            <h1 className="text-xl font-semibold">DeadPool</h1>
            <p>Cenima Hall Name</p>
          </div>
          ...
          <Modal onOpenChange={tickestChange} isOpen={openTickets}>
              ...
              <ul className="flex gap-1">
                {seat.s.map((s) => (
                  <li key={s.id} className="">
                    <Chip
                      color={`${s.isAvailable ? "secondary" : "default"}`}
